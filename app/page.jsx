      ...
      <div>
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                ...
                <div>
                  ...
                  <div style={{fontSize:17,fontWeight:900,color:"#fff",lineHeight:1.15,letterSpacing:0.2}}>{conf.name}</div>
        ...
        <div style={{background:UA.midnight,padding:"5px 20px"}}>
          <div style={{maxWidth:960,margin:"0 auto",display:"flex",alignItems:"center",gap:10}}>
            <img src="https://cdn.digital.arizona.edu/logos/v1.0.0/ua_wordmark_line_logo_white_rgb.min.svg" alt="The University of Arizona" style={{height:14,opacity:0.4}}/>
          </div>
        </div>
      </div>
